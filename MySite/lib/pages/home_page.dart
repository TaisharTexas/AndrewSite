...
class _HomePageState extends State<HomePage> {
  ...
  int _activeSection = 0; // 0=Home, 1=About, 2=Experience, 3=Contact
  ...
  void _onScroll() {
    // Get the Y position of each section relative to the viewport
    ...
    final home = _getOffset(HomePage.homeSectionKey);
    final about = _getOffset(HomePage.aboutSectionKey);
    final experience = _getOffset(HomePage.experienceSectionKey);
    final contact = _getOffset(HomePage.contactSectionKey);

    // Whichever section is closest to the top (but still on screen or just above) is active
    // We use a threshold of 200px from the top of the viewport
    const threshold = 200.0;
    int active = 0;

    // If at (or near) the bottom of the scroll, always highlight Contact
    final atBottom = _scrollController.position.pixels >=
        _scrollController.position.maxScrollExtent - 50;

    if (atBottom || (contact != null && contact <= threshold)) {
      active = 3;
  ...
  void _scrollToSection(int index) {
    switch (index) {
      case 0: HomePage.scrollToHomeSection(); break;
      case 1: HomePage.scrollToAboutSection(); break;
      case 2: HomePage.scrollToExperienceSection(); break;
      case 3: HomePage.scrollToContactSection(); break;
    }
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // HOME SECTION - Full-width banner image, then text
                    Container(
                      key: HomePage.homeSectionKey,
                      height: 260,
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(8),
                        image: const DecorationImage(
                          image: AssetImage('assets/images/pfp_mobile.jpeg'),
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(height: 2, width: 60, color: colors.primary.withOpacity(0.3)),
                    ...
                    Container(
                      key: HomePage.experienceSectionKey,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    // CONTACT SECTION
                    Container(
                      key: HomePage.contactSectionKey,
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                              ...
                              children: [
                                Row(children: [
                                  ...
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Text("andrew.taishar@icloud.com", style: textTheme.titleMedium),
                                  ])),
                                ]),
                                const SizedBox(height: 16),
                                Row(children: [
                                  Icon(Icons.business_outlined, color: colors.primary, size: 24),
                                  const SizedBox(width: 16),
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                const SizedBox(height: 16),
                                Row(children: [
                                  Icon(Icons.alternate_email, color: colors.primary, size: 24),
                                  const SizedBox(width: 16),
                                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8),
                            image: const DecorationImage(
                              image: AssetImage('assets/images/pfp_desktop.jpeg'),
                              fit: BoxFit.fitWidth,
                              alignment: Alignment.topCenter,
                            ),
                          ),
...
// Tab bar widget for mobile section navigation
class _SectionTabBar extends StatelessWidget {
  final int activeIndex;
  final void Function(int) onTap;

  const _SectionTabBar({required this.activeIndex, required this.onTap});

  static const _labels = ['Home', 'About', 'Experience', 'Contact'];
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    bottom: BorderSide(
                      color: isActive ? AppColors.onHoverBackground : Colors.transparent,
                      width: 2,
                    ),
                  ),
                ),
